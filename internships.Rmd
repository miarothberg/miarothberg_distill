...
```{r, echo = FALSE, out.width='30%', out.extra='style="float:left; padding:0px"'}
knitr::include_graphics("https://montgomeryplanning.org/wp-content/uploads/2020/08/Reforest-Montgomery-weblogo.jpg")
```
...
```{r echo = FALSE, out.width='30%', out.extra='style="float:left; padding:15px"'}
knitr::include_graphics("https://images.squarespace-cdn.com/content/v1/5c618f602727be3ec81d2285/1551794317427-J7K6FJY90TPBPALLQ956/EHTF-004_Collateral-16.jpg?format=1500w")
```
...
My main job was designing the annual survey for Network members, asking questions about achievements, equity initiatives, and performance metrics on SurveyMonkey, and distilling the information into Padlets (like [this one](https://greatplainsinstitute.padlet.org/kacuna3/i7jzkzbnw14d6xwl)) for them to present at the annual meeting near the end of my internship. 
...
knitr::include_graphics("cualogo.png")
```
